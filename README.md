...
Let's not be bothered and use a third-party package, aptly named [dj-rest-auth](https://dj-rest-auth.readthedocs.io/en/latest/installation.html), which will make our day better.
